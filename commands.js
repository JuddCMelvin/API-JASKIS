...
db.bounties.insertMany([
    ...
    ])
    {
        acknowledged: true,
        insertedIds: {
            '0': ObjectId('662d3ba9639fa96cd9d49dba'),
            '1': ObjectId('662d3ba9639fa96cd9d49dbb'),
            '2': ObjectId('662d3ba9639fa96cd9d49dbc'),
            '3': ObjectId('662d3ba9639fa96cd9d49dbd'),
            '4': ObjectId('662d3ba9639fa96cd9d49dbe'),
            '5': ObjectId('662d3ba9639fa96cd9d49dbf')
            }
        }
// MANAGE THE DATABASE
// Queries
...
db.bounties.updateOne({name: "Polarwind"},{$set: {reward: 1000}})
// 2. Remove Lokinkajou
